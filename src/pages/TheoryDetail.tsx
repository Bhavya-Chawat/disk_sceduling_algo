...
> = {
  fcfs: {
    definition:
      "First Come First Serve (FCFS) is the simplest disk scheduling algorithm that processes I/O requests in the order they arrive in the disk queue, without any reordering or optimization. Also known as First In First Out (FIFO) scheduling.",
    workingPrinciple: [
  ...
  sstf: {
    definition:
      "Shortest Seek Time First (SSTF) selects the pending request closest to the current head position. It minimizes seek time for each individual request but may cause starvation of distant requests.",
    workingPrinciple: [
      "Initialize the disk head at the starting position",
  ...
  scan: {
    definition:
      "SCAN algorithm (also called Elevator Algorithm) moves the disk head in one direction, servicing all requests until it reaches the end of the disk, then reverses direction and services requests going the other way.",
    workingPrinciple: [
    ...
    formula:
      "Move in direction d until end, reverse, continue until all serviced",
    advantages: [
  ...
  cscan: {
    definition:
      "Circular SCAN (C-SCAN) is a variant of SCAN that provides more uniform wait time. The head moves in one direction only, and when it reaches the end, it immediately returns to the beginning of the disk without servicing requests on the return trip.",
    workingPrinciple: [
    ...
    formula:
      "Service in one direction only, jump back to start when reaching end",
    advantages: [
  ...
  look: {
    definition:
      "LOOK is an optimization of SCAN. Instead of going all the way to the end of the disk, it only goes as far as the last request in each direction, then reverses. This eliminates unnecessary movement to disk boundaries.",
    workingPrinciple: [
      "Start from current head position with given direction",
      "Move head in the current direction",
      "Service all requests in the path",
  ...
  clook: {
    definition:
      "Circular LOOK (C-LOOK) combines the benefits of C-SCAN and LOOK. It moves in one direction, servicing requests, then jumps to the first request at the other end (not the disk boundary) and continues in the same direction.",
    workingPrinciple: [
      "Start from current head position",
    ...
    formula:
      "Like C-SCAN but only go to first/last requests, not disk boundaries",
    advantages: [
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="py-2 px-3 text-left text-muted-foreground">
                        Step
                      </th>
                      <th className="py-2 px-3 text-left text-muted-foreground">
                        From
              ...
              <div className="mt-4 p-4 bg-primary/10 rounded-lg">
                <p className="font-semibold text-foreground">
                  ...
                  <span className="text-primary">
                    {content.example.total} cylinders
                  </span>
                </p>
                <p className="font-semibold text-foreground">
                  Average Seek Time (AST) ={" "}
                  <span className="text-accent">
                    {content.example.average} cylinders
                  </span>
                </p>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-secondary/30 rounded-lg">
                  ...
                  <p className="text-lg font-mono text-orange">
                    {content.complexity.worst}
                  </p>
                </div>
              </div>
            </motion.section>
