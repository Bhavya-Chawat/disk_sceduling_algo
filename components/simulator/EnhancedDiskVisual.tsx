...
const algorithmTheory: Record<string, {
  definition: string;
  howItWorks: string[];
  advantages: string[];
  ...
  FCFS: {
    definition: 'First Come First Serve (FCFS) is the simplest disk scheduling algorithm that services requests in the order they arrive in the disk queue.',
    howItWorks: [
    ...
    example: 'If requests are [98, 183, 37] and head is at 50, it goes: 50→98→183→37 (total seek = 48+85+146 = 279)'
  },
  SSTF: {
    definition: 'Shortest Seek Time First (SSTF) selects the request that is closest to the current head position, minimizing seek time for each individual request.',
    howItWorks: [
    ...
    bestFor: 'Systems where performance is important but some unfairness is acceptable',
    timeComplexity: 'O(n²) - need to find minimum distance for each step',
    example: 'Requests [98, 183, 37] at head 50: Goes to 37 (nearest), then 98, then 183 (total seek = 13+61+85 = 159)'
  },
  SCAN: {
    definition: 'SCAN (Elevator Algorithm) moves the head in one direction servicing requests until it reaches the end of the disk, then reverses direction.',
    howItWorks: [
    ...
    example: 'Requests [98, 183, 37] at 50 going right: 50→98→183→199(end)→37 (total seek = 48+85+16+162 = 311)'
  },
  'C-SCAN': {
    definition: 'Circular SCAN (C-SCAN) moves in one direction, and when it reaches the end, it jumps back to the beginning and continues in the same direction.',
    howItWorks: [
    ...
    timeComplexity: 'O(n log n) for sorting requests',
    example: 'Requests [98, 183, 37] at 50 going right: 50→98→183→199(end)→0→37 (total seek = 48+85+16+199+37 = 385)'
  },
  LOOK: {
    definition: 'LOOK is similar to SCAN but only goes as far as the last request in each direction, not to the end of the disk.',
    howItWorks: [
    ...
    bestFor: 'Most modern disk systems - good balance of performance and fairness',
    timeComplexity: 'O(n log n) for sorting requests',
    example: 'Requests [98, 183, 37] at 50 going right: 50→98→183→37 (total seek = 48+85+146 = 279)'
  },
  'C-LOOK': {
    definition: 'Circular LOOK (C-LOOK) is like C-SCAN but only goes to the last request before jumping back, combining efficiency of LOOK with uniformity of C-SCAN.',
    howItWorks: [
    ...
    timeComplexity: 'O(n log n) for sorting requests',
    example: 'Requests [98, 183, 37] at 50 going right: 50→98→183→37 (jumps to start) (total seek = 48+85+146 = 279)'
  }
};

export default function EnhancedDiskVisual({ result, totalTracks }: EnhancedDiskVisualProps) {
              ...
              <div className="glass-card rounded-xl p-4">
                <div className="flex justify-between items-center text-sm">
                  <div>
                    ...
                    <span className="font-bold">0 - {maxTrack}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Total Distance: </span>
                    <span className="font-bold text-orange-500">{result.totalSeekTime} tracks</span>
                  </div>
                  <div>
            ...
            >
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="glass-card p-6 rounded-xl">
                  <h3 className="text-2xl font-bold mb-4 text-blue-600">📚 Definition</h3>
                  <p className="text-gray-700 text-lg leading-relaxed">{theory.definition}</p>
                </div>

                {/* How It Works */}
                <div className="glass-card p-6 rounded-xl">
                  <h3 className="text-2xl font-bold mb-4 text-purple-600">⚙️ How It Works</h3>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Advantages */}
                  <div className="glass-card p-6 rounded-xl">
                    <h3 className="text-2xl font-bold mb-4 text-green-600">✅ Advantages</h3>
                  ...
                  {/* Disadvantages */}
                  <div className="glass-card p-6 rounded-xl">
                    <h3 className="text-2xl font-bold mb-4 text-red-600">❌ Disadvantages</h3>
                    <ul className="space-y-2">
                ...
                <div className="glass-card p-6 rounded-xl bg-gradient-to-r from-orange-50 to-pink-50">
                  <h3 className="text-2xl font-bold mb-4 text-orange-600">🎯 Best Use Case</h3>
                  <p className="text-gray-700 text-lg">{theory.bestFor}</p>
                </div>

                {/* Complexity */}
                <div className="glass-card p-6 rounded-xl">
                  <h3 className="text-2xl font-bold mb-4 text-cyan-600">⏱️ Time Complexity</h3>
                ...
                <div className="glass-card p-6 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50">
                  <h3 className="text-2xl font-bold mb-4 text-blue-600">💡 Example</h3>
